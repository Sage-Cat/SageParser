...
if(NOT TARGET pugixml::shared)
    add_library(pugixml::shared INTERFACE IMPORTED)
    set_property(TARGET pugixml::shared PROPERTY INTERFACE_LINK_LIBRARIES pugixml::pugixml)
endif()
